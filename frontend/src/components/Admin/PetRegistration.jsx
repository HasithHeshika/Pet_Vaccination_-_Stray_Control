    ...
    return (
      <div className="dashboard">
        <div className="card" style={{ maxWidth: '600px', margin: '0 auto' }}>
          <h2 style={{ color: '#57321f', textAlign: 'center' }}>Pet Registered Successfully!</h2>
          ...
          <div style={{ marginTop: '20px', textAlign: 'center' }}>
            ...
            <img 
              ...
              alt="Pet QR Code" 
              style={{ maxWidth: '300px', border: '2px solid rgba(87, 50, 31, 0.18)', padding: '10px', borderRadius: '8px' }}
            />
  ...
  return (
    <div className="dashboard">
      <div className="form-container" style={{ maxWidth: '700px', margin: '0 auto' }}>
        ...
        <div style={{ background: '#fff4e8', padding: '15px', borderRadius: '8px', marginBottom: '20px', border: '1px solid rgba(87, 50, 31, 0.14)' }}>
